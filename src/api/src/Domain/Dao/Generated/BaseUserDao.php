...
/**
 * The BaseUserDao class will maintain the persistence of User class into the users
 * table.
 */
abstract class BaseUserDao
{
     ...
     */
    public function save(\App\Domain\Model\User $obj) : void
    {
     ...
     * Get all User records.
     *
     * @param \App\Domain\Model\User $obj The object to delete
     * @param bool $cascade If true, it will delete all objects linked to $obj
     */
    public function delete(\App\Domain\Model\User $obj, bool $cascade = false) : void
    {
        if ($cascade === true) {
