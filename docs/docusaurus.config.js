...
const config = {
  title: 'Symfony Nuxt Boilerplate',
  tagline: 'A Boilerplate with Symfony 6 and Nuxt 3',
  favicon: 'img/favicon.ico',

  // Set the production url of your site here
  url: 'httphttps://symfony-nuxt-boilerplate.netlify.app/',
  trailingSlash: false,
    ...
    ({
      ...
      navbar: {
        ...
        items: [
          ...
          {
            href: 'https://github.com/thecodingmachine/symfony-boilerplate/tree/v2',
            label: 'GitHub',
            position: 'right',
          },
        ],
